...
#define CAM_NAME "ESP32-cam server"
...
struct station stationList[] =  {
                                  // {"SlamNet", "SLAM1234", true},
                                  {"LARS","LARS@ROBOTICA", true},
                                  {"saiot","u2345678", true},
                                  {"Ap401","P1st4ch3", true},
                                  {"brisa-2138502","sapij9f7", true}
                                };
...
// warning - IP addresses must be separated with commas (,) and not decimals (.)
#define AP_ADDRESS 192,168,4,84
